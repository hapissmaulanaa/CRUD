...
if ($_POST) {
    ...
    if (empty($nama_siswa)) {
        ...
        "<script>alert('Password tidak boleh kosong');location.href='tambah_siswa.php';</script>";
    }else {
        include "koneksi.php";
        ...
        if ($insert) {
            ...
            "<script>alert('Gagal menambahkan siswa');location.href='tambah_siswa.php';</script>";
        }
    }
}
?>